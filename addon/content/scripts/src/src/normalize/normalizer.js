...
import { convertBlocksToChunks, DEFAULT_CHUNK_CONFIG } from "./chunk-converter.js";
import { createEnhancedChunkConverter, DEFAULT_ENHANCED_CHUNK_CONFIG } from "./enhanced-chunk-converter.js";
/**
 ...
 */
export function normalizeMineruDocument(raw, parseBackend = "agent", chunkConfig, embeddingModel, advancedParseResult) {
